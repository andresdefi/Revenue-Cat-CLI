...
func TestListCommandsAllFollowNextPagePath(t *testing.T) {
	tests := []struct {
		...
		{name: "subscriptions", args: []string{"subscriptions", "list", "--all", "--output", "json"}, path: "/projects/proj_cmdtest/subscriptions"},
		...
		{name: "purchases", args: []string{"purchases", "list", "--all", "--output", "json"}, path: "/projects/proj_cmdtest/purchases"},
